...
- In order to account for the randomness and fluctuations in score, I have added 2 additional data points to the graph alongside the scores. Namely, these are the mean score and the running average of the last 16 runs since the mean is offset by early failures. 
